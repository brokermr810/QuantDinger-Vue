...
const locale = {
  ...
  'trading-assistant.indicatorEmpty.desc': 'Create or purchase a technical indicator on the Indicator Analysis page, then return here to select it.',
  'trading-assistant.indicatorEmpty.cta': 'Go to Indicator Analysis',
